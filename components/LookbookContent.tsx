...
const VIDEO_SRC = '/lookbook/Main%20Video/Project%20Page%20main%20video.mov'
const POSTER_SRC = '/lookbook/hero-poster.jpg'
...
export default function LookbookContent({
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <EditorialStatement paragraphs={statementParagraphs} author={statementAuthor} />

      <ImageGridWithLightbox images={runwayImages.slice(0, 12)} onImageClick={handleImageClick} />
      ...
      <SectionHeader date={fittingsDate} title={fittingsTitle} />
      <TwoUpEditorial images={fittingsImages.slice(0, 2)} />

      <div className="bg-white py-8 md:py-12">
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          <img src={largeFittingPhoto.src} alt={largeFittingPhoto.alt} className="w-full h-auto" />
        </div>
      </div>

      <SectionHeader date={detailsDate} title={detailsTitle} />
      <HorizontalScrollGallery images={detailImages} height={{ mobile: 320, desktop: 420 }} />
      ...
      <div className="bg-black py-16 md:py-24 px-6 md:px-12">
        <div className="max-w-3xl text-left">
          <p className="text-4xl md:text-6xl font-la-foonte uppercase tracking-wide text-white leading-tight whitespace-pre-line">
            {footerText}
          </p>
